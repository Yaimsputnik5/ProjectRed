...
public class GateComponentModels {
    ...
    public static class FabricatedICModel extends ComponentModel {
        ...
        public void renderName(String name, Transformation t1, PoseStack mStack, MultiBufferSource bufferSource, int packedLight) {
            ...
            fr.drawInBatch(nameComponent, 0f, 0f, 0xFFFFFFFF, false, mStack.last().pose(), bufferSource, Font.DisplayMode.NORMAL, 0, packedLight);
            mStack.popPose();
        }
