...
public class ExplorationWorldFeatures {
    ...
    public static void bootstrapFeatures(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        //TODO Only generate based on ProjectRed config
        registerOreConfiguration(context, RUBY_ORE_CONFIGURED_FEATURE,        RUBY_ORE_BLOCK, DEEPSLATE_RUBY_ORE_BLOCK,         Configurator.gen_RubyVeinSize);
        registerOreConfiguration(context, SAPPHIRE_ORE_CONFIGURED_FEATURE,    SAPPHIRE_ORE_BLOCK, DEEPSLATE_SAPPHIRE_ORE_BLOCK, Configurator.gen_SapphireVeinSize);
        registerOreConfiguration(context, PERIDOT_ORE_CONFIGURED_FEATURE,     PERIDOT_ORE_BLOCK, DEEPSLATE_PERIDOT_ORE_BLOCK,   Configurator.gen_PeridotVeinSize);
        registerOreConfiguration(context, ELECTROTINE_ORE_CONFIGURED_FEATURE, ELECTROTINE_ORE_BLOCK, DEEPSLATE_ELECTROTINE_ORE_BLOCK, Configurator.gen_ElectrotineVeinSize);
        registerOreConfiguration(context, TIN_ORE_CONFIGURED_FEATURE,         TIN_ORE_BLOCK, DEEPSLATE_TIN_ORE_BLOCK,           Configurator.gen_TinVeinSize);
        registerOreConfiguration(context, SILVER_ORE_CONFIGURED_FEATURE,      SILVER_ORE_BLOCK, DEEPSLATE_SILVER_ORE_BLOCK,     Configurator.gen_SilverVeinSize);
    }
    ...
    public static void bootstrapBiomeModifiers(BootstapContext<BiomeModifier> context) {
        ...
        // Overworld biome ores
        context.register(createBiomeModifierKey("overworld_ores"), new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures::getOrThrow,
                        RUBY_ORE_PLACED_FEATURE,
                        SAPPHIRE_ORE_PLACED_FEATURE,
                        PERIDOT_ORE_PLACED_FEATURE,
                        ELECTROTINE_ORE_PLACED_FEATURE,
                        TIN_ORE_PLACED_FEATURE,
                        SILVER_ORE_PLACED_FEATURE),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(createBiomeModifierKey("overworld_biome_carvers"), new AddCarversBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(worldCarvers.getOrThrow(MARBLE_CAVE_CONFIGURED_CARVER)),
